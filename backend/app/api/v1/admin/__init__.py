...
보험사, 보험 상품, 보장 항목 CRUD API와
임베딩 관리 API를 포함하는 Admin 라우터.
"""
...
from app.api.v1.admin.embeddings import router as embeddings_router
...
admin_router.include_router(embeddings_router, prefix="/embeddings")
